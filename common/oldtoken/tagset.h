...
public:
	...
	TagSetNOld(const TagSetNOld<SIZE> & tagset) {
	...
	bool operator==(const TagSetNOld<SIZE> & tagset) const {
	...
	TagSetNOld<SIZE> & operator=(const TagSetNOld<SIZE> & tagset) {
		memcpy(m_lBits, tagset.m_lBits, sizeof(m_lBits));
		return *this;
	}

	friend std::istream & operator>>(std::istream & is, TagSetNOld<SIZE> & tagset) {
	...
	friend std::ostream & operator<<(std::ostream & os, const TagSetNOld<SIZE> & tagset) {
