#ifndef _POSTAG_MACROS_H
#define _POSTAG_MACROS_H
...
namespace POSTagging {
	...
	typedef TriGram<gtype> WordTagInt;
	typedef TriGram<gtype> TagTagInt;

	typedef QuarGram<gtype> TagTagTagInt;
	typedef QuarGram<gtype> WordWordTagInt;
	typedef QuinGram<gtype> WordWordWordTagInt;
	typedef QuinGram<gtype> WordTagWordTagInt;
	typedef QuarGram<gtype> CharWordTagInt;
	typedef QuarGram<gtype> WordTagTagInt;

	typedef QuinGram<gtype> CharCharCharTagInt;

	typedef TriGram<gtype> CharTagInt;

	typedef QuarGram<gtype> CharCharTagInt;

	typedef PackedScoreMap<WordTagInt, EISNER_PACKED_SIZE> WordTagIntMap;
	typedef PackedScoreMap<WordTagTagInt, EISNER_PACKED_SIZE> WordTagTagIntMap;
	typedef PackedScoreMap<WordTagWordTagInt, EISNER_PACKED_SIZE> WordTagWordTagIntMap;
	typedef PackedScoreMap<WordWordTagInt, EISNER_PACKED_SIZE> WordWordTagIntMap;
	typedef PackedScoreMap<WordWordWordTagInt, EISNER_PACKED_SIZE> WordWordWordTagIntMap;
	typedef PackedScoreMap<TagTagInt, EISNER_PACKED_SIZE> TagTagIntMap;
	typedef PackedScoreMap<CharWordTagInt, EISNER_PACKED_SIZE> CharWordTagIntMap;
	typedef PackedScoreMap<TagTagTagInt, EISNER_PACKED_SIZE> TagTagTagIntMap;
	typedef PackedScoreMap<CharTagInt, EISNER_PACKED_SIZE> CharTagIntMap;
	typedef PackedScoreMap<CharCharCharTagInt, EISNER_PACKED_SIZE> CharCharCharTagIntMap;
	typedef PackedScoreMap<CharCharTagInt, EISNER_PACKED_SIZE> CharCharTagIntMap;
